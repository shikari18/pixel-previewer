    ...
    <div className="fixed inset-0 bg-black text-white flex justify-center overflow-hidden">
      <div className="relative w-full max-w-md h-full flex flex-col px-8 pt-12 pb-6 overflow-hidden">
        ...
        <div className="mt-10 space-y-4">
          <button className="w-full rounded-2xl border border-white/10 bg-white/[0.03] py-5 flex items-center justify-center gap-3 text-base font-medium relative">
        ...
        <form className="mt-8 space-y-4" onSubmit={(e) => e.preventDefault()}>
          <input
            ...
            className="w-full rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-5 text-base placeholder:text-white/40 focus:outline-none focus:border-white/25"
          />
          <input
            type="email"
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-5 pr-14 text-base placeholder:text-white/40 focus:outline-none focus:border-white/25"
            />
            <button
              type="button"
          ...
          <button
            type="submit"
            className="mt-4 w-full rounded-2xl bg-white text-black font-medium py-5 text-base shadow-[0_0_40px_rgba(255,255,255,0.2)]"
          >
            Sign Up
          </button>
        </form>
