...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Create Account — Flow State" },
      { name: "description", content: "Create your Flow State account to focus deeply and learn smarter." },
      { property: "og:title", content: "Create Account — Flow State" },
      { property: "og:description", content: "Create your Flow State account to focus deeply and learn smarter." },
    ],
  }),
  component: SignUp,
});
    ...
    <div className="fixed inset-0 bg-black text-white flex justify-center overflow-hidden">
      <div className="relative w-full max-w-md h-full flex flex-col px-8 pt-12 pb-6 overflow-hidden">
        ...
        <div className="mt-6">
          ...
          <p className="mt-2 text-base text-white/50">Let's get you started</p>
        </div>

        <div className="mt-6 space-y-3">
          <button className="w-full rounded-2xl border border-white/10 bg-white/[0.03] py-3.5 flex items-center justify-center gap-3 text-sm font-medium relative">
        ...
        <form className="mt-4 space-y-3" onSubmit={handleSubmit}>
          <input
            ...
            className="w-full rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-3.5 text-sm placeholder:text-white/40 focus:outline-none focus:border-white/25"
          />
          <input
            type="email"
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-3.5 pr-14 text-sm placeholder:text-white/40 focus:outline-none focus:border-white/25"
            />
            <button
              type="button"
          ...
          <button
            type="submit"
            className="mt-2 w-full rounded-2xl bg-white text-black font-medium py-3.5 text-sm shadow-[0_0_40px_rgba(255,255,255,0.2)]"
          >
            Sign Up
          </button>
        </form>
