    ...
    <div className="fixed inset-0 bg-[#111111] text-white flex justify-center overflow-hidden page-transition">
      <div className="relative w-full max-w-md h-full flex flex-col">
        ...
        {(() => {
          ...
          return (
            <div className={`relative flex items-center w-full px-6 pt-8 pb-3 flex-shrink-0 transition-all duration-300 z-10 ${isScrolled ? "border-b border-white/5 bg-[#111111]/90 backdrop-blur-md pt-5 pb-2" : ""}`}>
