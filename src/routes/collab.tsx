...
import { Plus, ChevronRight, Users, Sparkles, Home, LayoutGrid, Search, X, Calendar } from "lucide-react";
...
function CollabPage() {
  ...
  const navItems = [
    ...
    { icon: <Calendar className="h-5 w-5" strokeWidth={1.5} />, label: "Calendar", active: false, to: "/calendar" },
